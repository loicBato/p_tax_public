                        ...
                        >
                            ...
                            <div className="flex-1 space-y-1">
                                ...
                                <div className="flex flex-wrap items-center gap-6">
                                    <div className="flex items-center gap-2 text-[11px] text-text-secondary uppercase">
                                        <Car className="w-3 h-3" /> {doc.plateNumber}
                                    </div>
                                    <div className="w-px h-3 bg-divider" />
                                    <div className="flex items-center gap-2 text-[11px] text-text-secondary">
                                        <Clock className="w-3 h-3" /> {moment(doc.date).format('DD/MM/YYYY HH:mm:ss')}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-8 md:pl-10 md:border-l border-divider">
                                <div className="text-right hidden sm:block">
                                    {doc?.type === 'PROCES_VERBAL' && <p className="text-xl font-bold text-text-title leading-tight">{doc.amount ? `${doc.amount.toLocaleString()} FCFA` : '—'}</p>}
